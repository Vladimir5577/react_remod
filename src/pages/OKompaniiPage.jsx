  ...
  return (
    <div className="min-h-screen bg-bg pt-24 pb-16">
      <div className="max-w-container mx-auto container-px">
        ...
        <div className="flex flex-col items-center text-center gap-4 p-10 rounded-2xl border border-border bg-ink text-bg">
          <h2 className="text-heading font-bold">Готовы обсудить ваш проект?</h2>
          <p className="text-body text-bg/70 max-w-[400px]">Расскажите о квартире — подготовим предварительную оценку за 10 минут.</p>
          <Link to="/ocenka" className="inline-flex items-center gap-2 px-7 py-3.5 bg-bg text-ink text-body-sm font-semibold rounded-pill hover:bg-bg-secondary transition-colors group">
